...
class ProctoringEngine:
    ...
    def handle_violation(self, violation_type):
        ...
        print(f"[⚠️ Violation Detected] {violation_type} | Total Violations: {self.status['violations']}")
    ...
    def default_flag_callback(self, violation_type):
        print(f"[⚠️ Default Callback] Violation Detected: {violation_type}")
