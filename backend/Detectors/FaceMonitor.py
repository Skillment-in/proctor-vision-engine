...
class FaceMonitor:
    ...
    def is_lip_moving_recently(self, threshold=2):
        return time.time() - self.last_lip_movement_time < threshold
    ...
    def monitor(self):
        ...
        while True:
            ...
            lip_moving = self.detect_lip_movement(frame)
            ...
            cv2.imshow('Face Verification + Lip Detection', frame)
